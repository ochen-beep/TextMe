...
export function loadSettingsUI() {
    ...
    // Re-apply injection after numeric fields change (depth/messages affect the block)
    $('#textme_rp_inject_messages, #textme_rp_inject_depth').on('change', function () {
        updateRpInjection();
    });
 ...
 * new jQuery .on('change', ...) listener on the <select> element every time
