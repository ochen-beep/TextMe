 ...
 * the next timer tick.
 *
 * A short delay is added to simulate the character "seeing" the message
...
async function checkAndSend() {
    ...
    // This handles the case where the user sent a message while online but
    // the timer hadn't ticked yet, or came back from offline via schedule.
