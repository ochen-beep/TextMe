 ...
 * FIX: getScheduleContext() now injected at the end.
...
async function assembleSystemPrompt() {
    ...
    // FIX: getWorldInfoPrompt is async and requires a trigger string.
    try {
    ...
    // FIX: Was missing — status, activity and DND/Idle modifiers were never injected.
    try {
 ...
 * FIX: assembleSystemPrompt is now async.
