 ...
 *   console.  Fix: check result?.content first (extracted shape), keep
 *   the raw-API path as a secondary fallback.
 *
...
function extractTextFromResult(result) {
    ...
    log.debug('[Profile] Unexpected sendRequest result shape:', typeof result, result !== null && typeof result === 'object' ? Object.keys(result) : result);
    return '';
}
