 ...
 *
 * FIX: initPhoneUI() now calls ensurePhoneData() on startup so
 * chat_metadata is always initialized before the user can type.
 */
...
export function initPhoneUI() {
    ...
    // FIX: Pre-initialize chat_metadata so getPhoneData() never returns null
