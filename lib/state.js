...
If additional context is provided below (lorebook entries, recent RP events, character info) — use it to make the schedule more specific and accurate. Prioritize explicit facts from that context over generic assumptions.
