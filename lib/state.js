...
Output ONLY the raw JSON object. No markdown, no code fences, no explanation.`,
    ...
    // Merged from the old autonomousPrompt + autonomousTaskPrompt split.
    ...
    autonomous: `{{char}} hasn't heard from {{user}} in a while and decides to text first — not because they're bored or waiting, but because something in their day reminded them, or they just felt like it.
