...
function buildDayBlockRow(day, block, idx) {
    ...
    return `<div class="textme-day-block-row" data-idx="${idx}" style="display:flex;align-items:center;gap:6px;">
        <input class="textme-day-from" type="time" value="${b.from}" data-idx="${idx}" style="width:90px;">
        <span>–</span>
        <input class="textme-day-to" type="time" value="${b.to === '24:00' ? '00:00' : b.to}" data-idx="${idx}" style="width:90px;">
